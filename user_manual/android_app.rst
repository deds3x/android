...
To specify where they are located, in the *"Settings"* options, under `Camera uploads`_, enable one of *"Instant picture uploads"* or *"Instant video uploads"*. 
...
Photos and videos are not uploaded when they’re created, to avoid excessive battery use.

.. note::
   Please be aware that if you used the previous *Instant Uploads* feature, its configuration will not be used for Camera Uploads. You will need to enable and configure the Camera Uploads feature before it can be used.
